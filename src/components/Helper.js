const Helper = () => {
	const color = 'gray-neu';
	return (
		<div className=' pl-96 grid grid-cols-4'>
			<div className='space-y-12'>
				<h1 className={`text-white`}>Flat </h1>
				<div className={`w-24 h-24 nm-flat-${color}-xs rounded-lg`}></div>
			...
			<div className='space-y-12'>
				...
				<div className={`w-24 h-24 nm-concave-${color}-xs`}></div>
			...
			<div className='space-y-12'>
				...
				<div className={`w-24 h-24 nm-convex-${color}-xs`}></div>
			...
			<div className='space-y-12'>
				...
				<div className={`w-24 h-24 nm-inset-${color}-xs`}></div>
